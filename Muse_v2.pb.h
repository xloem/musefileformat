...
typedef struct _muse2_ComputingDevice {
    pb_callback_t os_type;
    pb_callback_t os_version;
    pb_callback_t hardware_model_name;
    pb_callback_t hardware_model_id;
    pb_callback_t processor_name;
    pb_callback_t processor_speed;
    bool has_number_of_processors;
    uint32_t number_of_processors;
    pb_callback_t memory_size;
    pb_callback_t bluetooth_version;
    pb_callback_t time_zone;
